...
public class InputDefaultDatabase {
	...
	public void saveNewBook() {
        ...
        bookRepo.save(new Book("강부원","격동의 20세기 한국, 시대를 이끈 선도자와 방향을 제시한 지도자가 무수히 이름을 날렸다. 그들은 일평생 부귀와 영달을 누렸다. 하지만 선도자와 지도자만 20세기 한국을 수놓지 않았다. 자신만의 방법으로 역사에 맞선 사람들을 알아보자",0,"역사에 불꽃처럼 맞선 자들.jpg",17000,"2022-05-18","믹스커피","역사에 불꽃처럼 맞선자들",16,0));
